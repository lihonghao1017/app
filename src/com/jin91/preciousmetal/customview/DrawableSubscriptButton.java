...
public class DrawableSubscriptButton extends DrawableButton {
    ...
    public DrawableSubscriptButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public DrawableSubscriptButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
...
//                MessageToast.showToast(drawLeft+"",0);
            }
