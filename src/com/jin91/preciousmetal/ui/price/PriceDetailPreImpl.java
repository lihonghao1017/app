...
public class PriceDetailPreImpl implements PriceDetailPre {
    ...
    public List<ListDialogEntity> initIndicatorData(List<ListDialogEntity> list) {
        ...
        list.add(new ListDialogEntity("MACD指标", 0));
        list.add(new ListDialogEntity("BOLL布林线", 1));
        list.add(new ListDialogEntity("KDJ随机指标", 2));
        list.add(new ListDialogEntity("RSI强弱指标", 3));
        list.add(new ListDialogEntity("SMA均线", 4));
        list.add(new ListDialogEntity("EMA均线", 5));
