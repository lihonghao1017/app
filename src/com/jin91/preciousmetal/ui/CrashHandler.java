...
import com.jin91.preciousmetal.util.sendemail.MailSenderInfo;
import com.jin91.preciousmetal.util.sendemail.SimpleMailSender;
...
//        }.start();
        ...
        sendEmail(result);
        Logger.i(MainActivity.TAG, result);
        return true;
    }
    ...
    private void sendEmail(final String content) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                mailInfo.setUserName("jinhua7602@163.com");
                mailInfo.setPassword("lijinhua7602");//您的邮箱密码
                mailInfo.setFromAddress("jinhua7602@163.com");
                mailInfo.setToAddress("1216043682@qq.com");
                mailInfo.setSubject("91jin错误日志");
